...
SERVICES = {
    ...
    "cards": [
        ...
        {"icon": "spark", "title": "Pickling & Edge Conditioning",
         "text": "Turbulence HCl pickling of your hot-rolled coils (HRPO) with edge conditioning and oiling — weekend capacity on our 1.6 MTPA line.",
         "price": "from ₹2,600/t"},
        {"icon": "coil", "title": "Recoiling & Re-inspection",
         "text": "Coil-to-coil rewinding with 100% surface re-inspection, gauge mapping, re-strapping and stencil — ideal before critical draws.",
         "price": "from ₹900/t"},
        {"icon": "pack", "title": "Surface Finishing & Polishing",
         "text": "Stainless brushing (No.4 / hairline), bright-annealing coordination and PVC protective-film lamination on any coil.",
         "price": "from ₹2,200/t"},
        {"icon": "truck", "title": "Scrap Buy-Back & Reverse Logistics",
         "text": "We purchase your skeleton scrap and process offcuts — briquetting, EPR documentation and circularity credits for your ESG report.",
         "price": "market-linked"},
        {"icon": "team", "title": "Embedded Engineer Programme",
         "text": "A resident eShodha application engineer stationed at your plant for forming trials, die support and consumption planning.",
         "price": "₹1.4L/month"},
        {"icon": "doc", "title": "Export Packaging & Documentation",
         "text": "Seaworthy crating, VCI protection, COO/PCN, customs clearance and port handling to 40+ countries — door-to-door.",
         "price": "per consignment"},
        {"icon": "bolt", "title": "Digital Supply Services",
         "text": "EDI/API integration, live stock portal, consumption analytics and per-coil CO₂ footprint reports for your scope-3 accounting.",
         "price": "free for accounts"},
    ],
    "calculator": {
        ...
        "services": [
            ...
            {"id": "pickling", "label": "Pickling (HRPO)"},
            {"id": "recoiling", "label": "Recoiling & Re-inspection"},
            {"id": "polishing", "label": "Polishing / Hairline"},
        ],
        "materials": [
    ...
    "bookingTypes": [
        ...
        {"id": "scrap", "label": "Scrap Buy-Back Programme", "sla": "Quote in 3 working days"},
        {"id": "engineer", "label": "Embedded Engineer Request", "sla": "Deployment plan in 10 working days"},
        {"id": "prototype", "label": "Prototype / Sample Lot", "sla": "First article in 4–6 weeks"},
        {"id": "export", "label": "Export Service Booking", "sla": "Docs checklist in 2 working days"},
    ],
    "nextSteps": [
